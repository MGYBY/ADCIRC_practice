...
mshopts = meshgen('ef',fh1,'bou',gdat,'plot_on',1,'nscreen',5,'proj','trans', 'itmax', 240, 'qual_tol', 0.020);
...
m = interp(m,gdat, 'type', 'depth' ,'mindepth', -50.0); % interpolate bathy to the mesh with minimum depth of 1 m
% m = interp(m,gdat);
