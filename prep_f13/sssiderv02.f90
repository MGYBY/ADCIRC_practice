...
!occur.  
!
!Taylor Asher, created 2012-07-17
!Taylor Asher, modified 2013-11-15 to allow multiple wetelelim values
...
!         READ(15,*)seedx(cnt1),seedy(cnt1)
      ...
      tempseed=wetelelim
      DO cnt1=1,nseed
         wetelelim(nseed+1-cnt1)=tempseed(sortorder(cnt1))
      ENDDO
      tempseed=seedx
      DO cnt1=1,nseed
...
!.63output      write(17,*)'1 1'
      DO cnt1=1,nnod
         IF(startdry(cnt1).AND.dep(cnt1).GE.defwetdeplim) THEN
!            IF(dep(cnt1).GE.defwetdeplim) THEN
            WRITE(17,*)cnt1,1
!.63output         else
!.63output            write(17,*)cnt1,0
!            ENDIF
         ENDIF
      ENDDO
